...
<body>	
			...
			<div data-options="region:'north',fit:false,border:false,title:'查询条件',hideCollapsedContent:false" style="height:70px;overflow: hidden;padding:1px;background-color: #fff">
	    		<form id="detailSearchForm">
	    			...
	    			<div class="search_condition">
    					...
    					<p>
							<b>账户名称</b>
	                		<input id="role_query" name="name" type="text" placeholder="请输入账户名称" class="easyui-validatebox span2" maxlength="32" value=""/>
						</p>
    					<p>
							<b>账户类型</b>
    ...
    <div id="detailToolbar" style="display: none;">
        	<a onclick="addRARSFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'">关联账户</a>
