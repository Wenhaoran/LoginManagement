        ...
        <form id="texpjourPurchInvoiceDetViewForm" method="post">
            ...
            <table class="grid">
                ...
                <tr>
                    <td>创建时间</td>
                    <td>
                    	<input id="createOn" name="createOn" type="text" placeholder="请选择创建时间" class="easyui-validatebox span2" value="<fmt:formatDate value='${texpjourPurchInvoiceDet.createOn}' pattern='yyyy-MM-dd HH:mm:ss'/>" disabled="disabled"/>
                    </td>
                </tr>
                <tr>
                    <td>创建人名称</td>
