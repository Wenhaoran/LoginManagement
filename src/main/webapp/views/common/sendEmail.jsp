        ...
        <form id="tbaseMailTemplateEditForm" method="post">
            ...
            <table class="grid">
                <tr>
                    ...
                    <td>
                    	<input id="toMail" name="toMail" type="text" placeholder="请输入收件人" class="easyui-validatebox" data-options="required:true"  style="width: 700px;height: 20px;" maxlength="1024" value="${toUser}"/>
					</td>
                </tr>
                <tr>
                    <td><font color='red'>*</font>抄送：</td>
                    <td>
                    	<input id="toMail" name="toMail" type="text" placeholder="请输入抄送人" class="easyui-validatebox" data-options="required:true"  style="width: 700px;height: 20px;"  maxlength="2048" value="${cCEmail}"/>
					</td>
                </tr>
                <tr>
                    <td><font color='red'>*</font>主题：</td>
                    <td>
                    	<input id="title" name="title" type="text" placeholder="请输入主题" class="easyui-validatebox" data-options="required:true"  style="width: 700px;height: 20px;"  maxlength="2048" value="${title}"/>
					</td>
                </tr>
                 <tr>
                ...
                <tr>
					...
					<td>
					<textarea rows="35" cols="120" id="content" name = 'body' class="easyui-validatebox " data-options="required:true"  >${content}</textarea>
					</td>
                </tr>
            </table>
        </form>
